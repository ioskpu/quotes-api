# quote_api
Quote API RESTful Node.js multilingüe (italiano, inglés y español) es una API de citas (frases) gratuita y de código abierto para obtener citas aleatorias. Las citas se cargan en la base de datos sqlite3. 
